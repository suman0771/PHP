...
<form action="" method="POST">
    Name : <input type="text" name="name" ><span class="err"><?php echo $nameErr; ?></span><br>
    E-mail : <input type="text" name="email"><span class="err"><?php echo $emailErr; ?></span><br>

    Wesite link : <input type="text" name="website"><span class="err"><?php echo $websiteErr; ?></span><br>
    Remarks : <textarea name="remarks" id="" cols="30" rows="10"></textarea><span class="err"><?php echo $remarksErr; ?></span><br><br>
